...
<div class="aside col-xs-12 col-md-2 bg-dark">
    <div class="d-md-flex align-items-start flex-column d-sm-block h-full">
        ...
        <div class="h-100 w-100 position-relative to-top cursor d-none d-md-block mt-md-5 divider" data-action="click->html-load#goToTop" title="{{ __('views.vendor.platform.dashboard.upward') }}">
            <div class="bottom-left w-100 mb-2 ps-3">
                <small>
                    <x-orchid-icon path="arrow-up" class="me-2"/>

                    {{ __('views.vendor.platform.dashboard.upward') }}
